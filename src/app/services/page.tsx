...
const Services = () => {
    return (
        <section className='min-h-[920px] flex flex-col justify-center py-12 xl:py-0'>
                        ...
                        return (
                            <div key={service.num} className='flex-1 flex flex-col justify-center gap-6 group'>
                                <div className='w-full flex justify-between items-center'>
                                    ...
                                    <Link href={service.href} className='w-[70px] h-[70px] rounded-full bg-white group-hover:bg-accent transition-all duraion-500 flex justify-center items-center hover:-rotate-45'>
